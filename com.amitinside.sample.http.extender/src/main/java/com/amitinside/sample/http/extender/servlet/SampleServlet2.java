...
@HttpWhiteboardServletPattern("/sample2/*")
@HttpWhiteboardContextSelect("(" + HTTP_WHITEBOARD_CONTEXT_NAME + "=SampleContext2)")
public final class SampleServlet2 extends HttpServlet {
    ...
    protected void doGet(final HttpServletRequest request, final HttpServletResponse response) throws IOException {
        ...
        response.getWriter().print("Servlet2 Response");
    }
}
